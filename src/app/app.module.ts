...
const appRoutes: Routes = [
  ...
  { path: 'games/minesweeper', component: MinesweeperComponent, pathMatch: 'full', canActivate: [AuthGuard] },
  { path: 'games/cards', component: CardsComponent, pathMatch: 'full', canActivate: [AuthGuard] },
  { path: 'games/rpg', component: RpgComponent, pathMatch: 'full', canActivate: [AuthGuard] },
